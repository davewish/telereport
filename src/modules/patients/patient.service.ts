...
type Patient = Awaited<ReturnType<typeof prisma.patient.create>>;
export const createPatient = async (data: CreatePatientInput) => {
  return withSpan<Patient>("createPatient", async () => {
...
export const getPatients = async () => {
  return withSpan("getPatients", () => prisma.patient.findMany({ include: { reports: true } }));
};
export const getPatientById = async (id: string) => {
  return withSpan<Patient>("getPatient", async () => {
...
export const updatePatientCondition = async (id: string, condition: string, version: number) => {
  withSpan("updatePatientCondition", async () => {
